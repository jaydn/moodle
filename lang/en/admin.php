...
$string['configdebugfailedlogin'] = 'With this option disabled, failed logins will only emit a PHP error when error_reporting level includes E_ALL. When enabled, failed logins will always emit a PHP error regardless of debug level.';
...
$string['debugfailedlogin'] = 'Always log failed logins';
